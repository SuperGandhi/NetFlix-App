...
const Login = () => {
  return (
    <>
            ...
            <img className='hidden sm:block absolute w-full h-full object-cover'src="https://assets.nflxext.com/ffe/siteui/vlv3/6e32b96a-d4be-4e44-a19b-1bd2d2279b51/7a4bfd8d-ab2f-4b1c-bbdf-c59ff2a36db0/PE-es-20220516-popsignuptwoweeks-perspective_alpha_website_medium.jpg" alt="/" />
